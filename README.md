...
Форма «задать вопрос» (ФИО, способ связи, текст вопроса):

```json
{
  "full_name": "Иванова Мария Сергеевна",
  "contact": "mail@example.com",
  "question": "Хочу узнать расписание занятий."
}
```

Поле `contact` — любой способ связи: телефон, email, телеграм-ник, что угодно (до 255 символов).
