...
def _game_item(game: Game) -> GameListItem:
    return GameListItem(
        ...
        team_a=GameTeamItem(id=game.team_a.id, name=game.team_a.name, logo=game.team_a.logo),
        team_b=GameTeamItem(id=game.team_b.id, name=game.team_b.name, logo=game.team_b.logo),
